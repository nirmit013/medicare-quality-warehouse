...
/*
    Risk-adjusted mortality and complication rates, with 95% confidence intervals.
...
with source as (
    ...
    select * from {{ source('cms_raw', 'complications_deaths') }}
...
renamed as (
    ...
    select
        ...
        'Complications & Deaths'                               as measure_domain,
